...
@ServerEndpoint(value = "Price Listing")
public class PriceListResource implements WebsocketResource {
	...
	public void onMessage(String message, Session session) {
		...
		session.getAsyncRemote().sendText("Server says : Welcome price client!!!");
	}
